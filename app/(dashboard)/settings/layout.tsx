...
export default function SettingsLayout({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-1.5 ring-1 ring-slate-200/50 dark:ring-white/5 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl p-1.5 rounded-xl shadow-sm">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "flex items-center gap-2.5 px-6 py-3 rounded-xl transition-all duration-300 group whitespace-nowrap",
                  isActive 
              ...
              >
                ...
                <span className="text-[11px] font-semibold tracking-tight uppercase tracking-widest">{item.name}</span>
