    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-20">
      <div className="space-y-1">
        ...
        <p className="text-sm font-medium text-slate-500">
          Immutable audit trail for all operational and compliance events in <span className="text-slate-900 dark:text-white underline decoration-primary/30 underline-offset-4">{orgSlug}</span>.
        </p>
      </div>
