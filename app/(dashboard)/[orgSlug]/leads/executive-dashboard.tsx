...
function AnalyticsView({ leads, orgSlug }: { leads: Record<string, any>[]; orgSlug: string }) {
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-100 dark:border-white/5">
        <div className="flex items-center gap-6">
          <div className="h-10 w-auto">
            <Image src="/scalerxlab-logo.png" alt="ScalerX Lab" width={140} height={35} className="object-contain" />
          </div>
      ...
      <Tabs defaultValue="analytics" className="w-full">
        ...
        <TabsContent value="analytics" className="mt-8 animate-in fade-in slide-in-from-bottom-2">
          <AnalyticsView leads={initialLeads} orgSlug={orgSlug} />
        </TabsContent>
