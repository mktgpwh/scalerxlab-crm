      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 max-w-md leading-relaxed">
            Manage your external data streams and autonomous engagement channels for <span className="text-slate-900 dark:text-white underline decoration-primary/30 decoration-2 underline-offset-4 font-bold">{clinicName}</span>.
          </p>
        </div>
      ...
      <div className="mt-12">
        ...
        <div className="space-y-3">
          {[
            ...
            { name: "WON → Patient Record", url: "https://clinic.domain.in/api/patients", event: "STATUS_WON", status: "PENDING", calls: 0 },
          ].map((hook, i) => (
