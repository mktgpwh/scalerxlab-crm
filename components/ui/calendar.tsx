...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-6 bg-white dark:bg-slate-950 font-sans shadow-2xl ring-1 ring-slate-200/60 rounded-xl", className)}
      classNames={{
        root: "w-fit",
        ...
        button_previous: cn(
          ...
          "h-9 w-9 bg-white p-0 hover:bg-slate-100 hover:text-slate-900 rounded-xl transition-all shadow-sm ring-1 ring-slate-200"
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-9 w-9 bg-white p-0 hover:bg-slate-100 hover:text-slate-900 rounded-xl transition-all shadow-sm ring-1 ring-slate-200"
        ),
        month_caption: "flex justify-center pt-3 pb-1 font-semibold tracking-tight uppercase tracking-[0.2em] text-[#243467] text-[12px]",
        table: "w-full border-separate border-spacing-y-1 border-spacing-x-0 mt-2",
        weekdays: "flex font-semibold tracking-tight uppercase text-[10px] tracking-widest text-slate-400 mb-3",
        weekday: "flex-1 w-10 text-center border-0",
        week: "flex w-full",
        day: "p-0 border-0 outline-none",
        day_button: cn(
          "w-10 h-10 p-0 font-semibold text-sm rounded-full flex items-center justify-center transition-all hover:bg-slate-100 focus:outline-none cursor-pointer border-0"
        ),
        ...
        today: "text-[#243467] font-semibold tracking-tight bg-[#243467]/5",
